...
为了解决以上问题，我们和数据库平台研发组合作，研发了一套基于预训练的大容量异常检测服务来进行链路异常检测，其具有大容量，低时延，准确率高的特点。算法使用了历史长时序来挖掘时序特征参数，并在实时检测中参考临近120分钟进行了波动过滤，可以在较短的时间内快速识别指标的异常程度，实现了每分钟百万级别的异常检测。整体检测的平均流程耗时在1.5-3ms，检测的异常点[[精确率]]在81%，异常点[[召回率]]在82%，F1值为81%。
![[百万级异常发现检测能力架构图.png]]
...
词i权重≈词i在当前事件中的出现次数词i在多少个历史事件中出现
